...
abstract class BasePerson extends BaseObject  implements Persistent
{
  ...
  const PEER = 'PersonPeer';
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					if ($criteria->keyContainsValue(PersonPeer::PERSONID) ) {
	 ...
	 * @return     PropelCollection|array Outgoing[] List of Outgoing objects
	 */
	public function getOutgoingsJoinOperation($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = OutgoingQuery::create(null, $criteria);
		$query->joinWith('Operation', $join_behavior);
	 ...
	 * @return     PropelCollection|array Incoming[] List of Incoming objects
	 */
	public function getIncomingsJoinOperation($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$query = IncomingQuery::create(null, $criteria);
		$query->joinWith('Operation', $join_behavior);
