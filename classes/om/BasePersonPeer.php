...
abstract class BasePersonPeer {
	...
	public static function populateObject($row, $startcol = 0)
	{
		...
		if (null !== ($obj = PersonPeer::getInstanceFromPool($key))) {
			...
			$col = $startcol + PersonPeer::NUM_COLUMNS;
		} else {
	...
	{
		return $withPrefix ? PersonPeer::CLASS_DEFAULT : PersonPeer::OM_CLASS;
	}
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(PersonPeer::PERSONID) && $criteria->keyContainsValue(PersonPeer::PERSONID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.PersonPeer::PERSONID.')');
		}
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(PersonPeer::PERSONID);
			if ($value) {
				$selectCriteria->add(PersonPeer::PERSONID, $value, $comparison);
			} else {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			$c = clone $criteria;
			$affectedRows += PersonPeer::doOnDeleteCascade($c, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(OutgoingPeer::PERSONIDFK, $obj->getPersonid());
			...
			$criteria->add(IncomingPeer::PERSONIDFK, $obj->getPersonid());
