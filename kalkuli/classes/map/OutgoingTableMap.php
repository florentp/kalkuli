...
/**
 * This class defines the structure of the 'outgoing' table.
 *
 *
 *
 ...
 */
class OutgoingTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'classes.map.OutgoingTableMap';
	...
	{
	  // attributes
		$this->setName('outgoing');
		$this->setPhpName('Outgoing');
		$this->setClassname('Outgoing');
		$this->setPackage('classes');
		$this->setUseIdGenerator(true);
		// columns
		$this->addPrimaryKey('OUTID', 'Outid', 'INTEGER', true, null, null);
		$this->addColumn('OUTWEIGHT', 'Outweight', 'FLOAT', false, null, null);
